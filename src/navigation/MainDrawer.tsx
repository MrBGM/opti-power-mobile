...
export function MainDrawer() {
  return (
    ...
    >
      ...
      <Drawer.Screen name="Import" component={ImportGate} options={{ title: 'Importer données' }} />
      ...
      <Drawer.Screen name="AIInsights" component={AIInsightsScreen} options={{ title: 'IA / Prédictions' }} />
