...
const styles = StyleSheet.create({
  ...
  muted: { color: '#94a3b8' },
  mutedSmall: { color: '#64748b', fontSize: 12, lineHeight: 18 },
  mutedTiny: { color: '#475569', fontSize: 10, lineHeight: 14, marginTop: 8 },
  readOnlyBanner: {
  ...
  readOnlyTitle: { color: '#93c5fd', fontSize: 12, fontWeight: '800', textTransform: 'uppercase' },
  readOnlySub: { color: '#94a3b8', fontSize: 12, lineHeight: 18 },
  ...
  syncHintTitle: { color: '#fbbf24', fontSize: 13, fontWeight: '700' },
  card: {
  ...
  cardSubtitle: { color: '#94a3b8', fontSize: 12, marginBottom: 4 },
  costCard: {
    borderColor: 'rgba(245, 158, 11, 0.35)',
    backgroundColor: 'rgba(245, 158, 11, 0.06)',
  },
  name: { color: '#fff', fontSize: 21, fontWeight: '800' },
  desc: { color: '#94a3b8', fontSize: 13, lineHeight: 19, marginTop: 6, fontStyle: 'italic' },
  badge: {
  ...
  healthVal: { color: '#4ade80', fontSize: 18, fontWeight: '800' },
  healthLbl: { color: '#64748b', fontSize: 10, fontWeight: '700', textTransform: 'uppercase' },
  meta: { flexDirection: 'row', justifyContent: 'space-between', gap: 12, alignItems: 'flex-start' },
  metaLabel: { color: '#64748b', fontSize: 13, fontWeight: '600', maxWidth: '42%' },
  metaVal: { color: '#e2e8f0', fontSize: 13, flex: 1, textAlign: 'right' },
  sectionTitle: { color: '#64748b', fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.6 },
  kpiHint: { color: '#64748b', fontSize: 11, lineHeight: 16, marginBottom: 4 },
  ...
  kpiMiniLabel: { color: '#64748b', fontSize: 11, fontWeight: '600' },
  kpiMiniVal: { color: '#f8fafc', fontSize: 17, fontWeight: '800' },
  kpiMiniSub: { color: '#475569', fontSize: 10, lineHeight: 14 },
  legendRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginTop: 8, marginBottom: 4 },
  legendItem: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  legendDot: { width: 8, height: 8, borderRadius: 4 },
  legendTxt: { color: '#94a3b8', fontSize: 10, fontWeight: '600' },
  chartBox: { alignItems: 'center', marginVertical: 6 },
  ...
  summaryLabel: { color: '#64748b', fontSize: 10, fontWeight: '600' },
  summaryValue: { color: '#e2e8f0', fontSize: 13, fontWeight: '700' },
  summaryMuted: { color: '#64748b', fontSize: 11, marginTop: 8 },
  ...
  innerTitle: { color: '#cbd5e1', fontSize: 13, fontWeight: '700', marginBottom: 2 },
  costInner: { gap: 8 },
  pfBig: { color: '#f8fafc', fontSize: 28, fontWeight: '800', fontVariant: ['tabular-nums'] },
  pfSub: { color: '#64748b', fontSize: 11, marginBottom: 8 },
  harmRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 6 },
  harmRank: { width: 28, color: '#94a3b8', fontSize: 12, fontWeight: '700' },
  harmBarBg: {
    flex: 1,
    height: 8,
    borderRadius: 4,
  ...
  harmBarFill: { height: '100%', backgroundColor: '#60a5fa', borderRadius: 4 },
  harmVal: { width: 48, textAlign: 'right', color: '#e2e8f0', fontSize: 11, fontVariant: ['tabular-nums'] },
  phaseRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 8 },
  phaseLbl: { width: 28, color: '#94a3b8', fontSize: 12, fontWeight: '700' },
  phaseBarBg: {
    flex: 1,
    height: 8,
    borderRadius: 4,
  ...
  phaseVal: { width: 64, textAlign: 'right', color: '#e2e8f0', fontSize: 11, fontVariant: ['tabular-nums'] },
  imbalanceFooter: {
    flexDirection: 'row',
  ...
  imbalanceLbl: { color: '#6ee7b7', fontSize: 12, fontWeight: '600' },
